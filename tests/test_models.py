...
from papermint.models import Citation, Author, CitationStyle, EntryType, ExtractionResult
...
def test_citation_author_string():
    ...
    # 2 authors
    c2 = Citation(authors=[Author(given="John", family="Doe"), Author(given="Jane", family="Smith")])
    assert c2.author_string == "Doe, John & Smith, Jane"
    
    # 3 authors
    c3 = Citation(authors=[Author(given="John", family="Doe"), Author(given="Jane", family="Smith"), Author(given="Bob", family="Brown")])
